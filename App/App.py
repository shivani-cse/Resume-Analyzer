...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='shivani',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by Y Shivani</b>'
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Shivani ! Total %d " % values + " User's Have Used Our Tool : )")                
